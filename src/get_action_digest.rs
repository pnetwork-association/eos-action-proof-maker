...
mod tests {
    ...
    fn should_get_correct_action_digest_1() {
        let action = EosAction {
            ...
            data: hex::decode("304c32c92597305510e874d820054dc6e87506000000000004454f5300000000083138333436393935").unwrap(),
        };
    ...
    fn should_get_correct_action_digest_4() {
        // NOTE: From the submission material in example 1...
        let action = EosAction {
        ...
        // NOTE: From `cat example/example-1-submission-material.json | jq '.action_receipts[2].act_digest'
